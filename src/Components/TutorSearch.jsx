...
const TutorSearch = ({ tutors }) => {
    return (
        <section className="min-h-screen bg-[#f8fafc] py-16 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-600 text-lg max-w-2xl mx-auto font-medium">
                        আপনার শিক্ষার প্রয়োজন অনুযায়ী সেরা টিউটর খুঁজে নিন। আমাদের অভিজ্ঞ শিক্ষকরা আপনাকে কাঙ্ক্ষিত লক্ষ্যে পৌঁছাতে সাহায্য করবে।
                    </p>
