...
export const metadata = {
    title: "10 Minute School || My Tutors",
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-xs text-gray-400 font-medium">{item.tutorinstitution || "No Institution"}</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="px-6 py-4">
                                ...
                                <div key={index} className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 relative overflow-hidden group">
                                    <div className="flex items-start justify-between mb-4">
                                        <div className="flex gap-4">
                                            ...
                                            />
                                            <div>
                                                <h3 className="font-bold text-gray-800 text-lg leading-tight">{item.TecherName}</h3>
