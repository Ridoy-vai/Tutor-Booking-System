...
export const metadata = {
    title: "10 Minute School || Booked Tutors",
...
console.log("Bookings API response:", responseBody); // Debugging line to check the API response
console.log("Response status:", res); // Debugging line to check the response status
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
                    {[
                        ...
                        { label: "Pending", value: myTutorsDatas.filter((item) => item.bookingstatus === "Pending" || !item.bookingstatus).length, color: "text-amber-600", bg: "bg-amber-50" },
                        { label: "Confirmed", value: myTutorsDatas.filter((item) => item.bookingstatus === "Confirmed").length, color: "text-green-600", bg: "bg-green-50" },
                        { label: "Cancelled", value: myTutorsDatas.filter((item) => item.bookingstatus === "Cancelled").length, color: "text-red-600", bg: "bg-red-50" },
                    ].map((stat) => (
                                        ...
                                        {myTutorsDatas.map((item, index) => (
                                            <tr key={index} className="hover:bg-blue-50/30 transition-colors group">
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-xs text-gray-400 truncate max-w-[150px]">Join Date: {item.StudentBookingDate}</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center gap-3">
                                                        <img
                                                            src={item?.TutorBaner || `https://ui-avatars.com/api/?name=${item.TecherName}`}
                                                            className="w-10 h-10 rounded-xl object-cover ring-2 ring-gray-50"
                                                            alt={item.TecherName}
                                                        />
                                                        <div>
                                                            <p className="text-sm font-bold text-gray-800">{item.TecherName}</p>
                                                            <p className="text-[10px] text-gray-400 font-bold uppercase">Start: {new Date(item.tutorstartDate).toLocaleDateString()}</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td className="px-6 py-4">
                                                    <StatusBadge bookingstatus={item.bookingstatus} />
                                                </td>
                                ...
                                <div key={index} className="bg-white rounded-[2rem] p-6 shadow-sm border border-gray-100 relative group transition-all hover:shadow-md">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 bg-slate-50 p-4 rounded-2xl mb-6">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm font-bold text-indigo-600">{item.TutorSubject}</p>
                                        </div>
                                        <div>
                                        ...
                                        <div className="flex items-center gap-2">
                                            <img src={item.TutorBaner} className="w-6 h-6 rounded-full" />
                                            <p className="text-[10px] font-bold text-gray-600 truncate">{item.TecherName}</p>
                                        </div>
                                    </div>
